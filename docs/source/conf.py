...
# cartola_estimator documentation build
...
from cartola_estimator import __version__ as release

# -- Project information -----------------------------------------------------

project = "cartola_estimator"
author = "Kedro"
...
htmlhelp_basename = "cartola_estimatordoc"
...
latex_documents = [
    (
        master_doc,
        "cartola_estimator.tex",
        "cartola_estimator Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "cartola_estimator",
        "Project cartola_estimator codebase.",
        "Data-Science",
    )
]
