    ...
    df = pd.DataFrame(
        {
            ...
            "rodada": ["1", "2", "3", "1", "2", "3"],
            "mandante": ["Sao Paulo", "Coritiba", "Sao Paulo", "Athletico-PR", "Athletico-PR", "Bahia"],
            "visitante": ["Gremio", "Sao Paulo", "Cruzeiro", "Vasco", "Internacional", "Athletico-PR"],
            "vencedor": ["Gremio", "Sao Paulo", "-", "Vasco", "Athletico-PR", "Athletico-PR"],
        }
    )
    return df
    ...
    df = pd.DataFrame(
        {
            ...
            "clube": ["Sao Paulo", "Sao Paulo", "Sao Paulo", "Athletico-PR", "Athletico-PR", "Athletico-PR"],
            "G": [0, 1, 1, 0, 0, 1],
            "A": [0, 0, 1, 0, 2, 3],
        }
    )
...
@pytest.fixture(scope="module")
def stats_dict():
    return {"assistencias": {"id": "A", "pos":["mei", "ata"]}, "gols": {"id": "G", "pos":["mei", "ata"]}}
...
@pytest.fixture(scope="module")
def id_cols():
    return ["time_idx", "rodada", "ano", "clube", "atletas_slug", "oponente", "atletas_posicao_id"]